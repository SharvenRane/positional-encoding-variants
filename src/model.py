"""
Positional Encoding Variants - Model Architecture
"""
import torch
...
class PositionalEncodingVariants(nn.Module):
    """
    Main model for positional encoding variants.
    """
...
def build_model(config):
    model = PositionalEncodingVariants(config)
