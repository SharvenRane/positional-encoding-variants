"""
Positional Encoding Variants - Dataset
"""
import os
import torch
...
class PositionalEncodingVariantsDataset(Dataset):
    """Dataset for positional encoding variants."""
...
def get_dataloader(root, split, config):
    ...
    dataset = PositionalEncodingVariantsDataset(root, split, transform)
    return DataLoader(
        dataset,
